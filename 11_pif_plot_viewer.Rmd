...
- Yellow Watch List (R): Prevent Decline (n = 6) 
...
1) modeled smooths drawn from the GAMYE model using outputs derived from the bbsBayes2 package.
2) posterior draws drawn from continental wide annual indices estimates. 
